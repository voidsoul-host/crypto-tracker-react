...
export default function TogglePriceType({priceType, handlePriceTypeChange}) {
  ...
  return (
    <div className="toggle-prices">
      ...
      >
{/* value="prices, market_caps, total_volumes are intentionally typed like this because of match the value with given data by API with clicked button value.. so we can fetch the value which is clicked" */}
